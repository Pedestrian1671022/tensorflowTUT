...
def BiRNN(x, weights, biases):
    ...
    fw_layers = [tf.nn.rnn_cell.BasicLSTMCell(n_hidden, forget_bias=1.0) for _ in range(2)]
    bw_layers = [tf.nn.rnn_cell.BasicLSTMCell(n_hidden, forget_bias=1.0) for _ in range(2)]
